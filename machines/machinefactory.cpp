...
static const map<string, string> PropHelp = {
    ...
    {"bluescsi_dir",    "specifies directory path to expose via the BlueSCSI Toolbox protocol"},
    {"bluescsi_send_dir","specifies alternate directory path to copy files sent via the BlueSCSI Toolbox protocol. If empty, the bluescsi_dir path is used."},
    {"bluescsi_dir2",   "specifies directory path to expose via the BlueSCSI Toolbox protocol"},
    {"bluescsi_send_dir2","specifies alternate directory path to copy files sent via the BlueSCSI Toolbox protocol. If empty, the bluescsi_dir path is used."},
